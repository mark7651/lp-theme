...
function lp_register_exchange_taxonomy($taxonomy_name, $singular_name, $plural_name)
{
	$labels = array(
		...
		'parent_item'                => esc_html__("Parent {$singular_name}", 'lptheme'),
		'parent_item_colon'          => esc_html__("Parent {$singular_name}:", 'lptheme'),
		...
		'separate_items_with_commas' => esc_html__("Separate {$plural_name} with commas", 'lptheme'),
		'add_or_remove_items'        => esc_html__("Add or remove {$plural_name}", 'lptheme'),
		'choose_from_most_used'      => esc_html__("Choose from most used {$plural_name}", 'lptheme'),
...
{
	lp_register_exchange_taxonomy('city', 'City', 'Cities');
	lp_register_exchange_taxonomy('currency', 'Currency', 'Currencies');
	lp_register_exchange_taxonomy('crypto', 'Crypto', 'Crypto');
}
